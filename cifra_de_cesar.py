...
frase = sg.popup_get_text("OBS: Não utilizar caracteres especiais. \nPor gentileza, digite a frase: ", title="Escolha uma frase!",text_color = 'black', background_color = 'RoyalBlue', location = (500,250))
fraseFormatadaArray = list(frase.upper())

chave = sg.popup_get_text("Digite a chave para encriptação: ", title="Escolha da chave.", text_color = 'black', background_color = 'RoyalBlue', location = (500,250))
chave = int(chave)

escolha = sg.popup_get_text("Deseja encriptar ou decriptar sua mensagem? \nDigite 1 para encriptar; \nDigite 2 para decriptar;", title="Eis a questão...", text_color = 'black', background_color = 'RoyalBlue', location = (500,250))
escolha = int(escolha)
